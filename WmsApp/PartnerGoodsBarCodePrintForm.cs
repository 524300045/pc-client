...
namespace WmsApp
{
    public partial class PartnerGoodsBarCodePrintForm : TabWindow
    {
        ...
        public PartnerGoodsBarCodePrintForm()
        {
            InitializeComponent();
        ...
        private void BindDgv()
        {
            ...
            PartnerGoodsQueryRequest request = new PartnerGoodsQueryRequest();
