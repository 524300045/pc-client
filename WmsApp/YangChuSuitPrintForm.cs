...
namespace WmsApp
{
    public partial class YangChuSuitPrintForm : TabWindow
    {
        ...
        private void btnBox_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                YangChuSuitDateForm suitForm = new YangChuSuitDateForm(lastDateTime);
        ...
        public void GetPicture(Bitmap image, PrintPageEventArgs g)
        {
           ...
           // int heightRight = 15;
            ...
            g.Graphics.DrawString(goodsSuitBox.skuCode + "央厨牛八件", font, brush, layoutRectangle);
