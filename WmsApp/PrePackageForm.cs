...
namespace WmsApp
{
    public partial class PrePackageForm : TabWindow
    {
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    DataColumn dc13= new DataColumn("加工小组");
                    ...
                    if (!response.IsError)
                    {
                        if (response.result != null)
                        {
                            for (int i = 0; i < response.result.Count; i++)
                            {
                                ...
                                dr[10] = response.result[i].groupName;
                                dtExecl.Rows.Add(dr);
                            }
                        }
                    }
                    ...
                    if ((bool)dataGridView1.Rows[i].Cells[0].EditedFormattedValue == true)
                    {
                        ...
                        if (this.dataGridView1.Rows[i].Cells["isStandardProcess"].Value.ToString() == "1")
                        {
                            ...
                            for (int n = 0; n < diff; n++)
                            {
                                ...
                                add.deliveryDate = dtBegin.Value.ToString("yyyy-MM-dd HH:mm:ss");
                                add.productionDate = productDate + " 00:00:00";
                            ...
                            {
                                if (UserInfo.CustomerCode == "15001" 
                                       || UserInfo.CustomerCode == "22001" || UserInfo.CustomerCode == "31001" 
                                     || UserInfo.CustomerCode == "37001" || UserInfo.CustomerCode == "25001" || UserInfo.CustomerCode == "26001"
                                     || UserInfo.CustomerCode == "26002" || UserInfo.CustomerCode == "38001" || UserInfo.CustomerCode == "39001"
                                    )
                                {
                                    #region 青柠泰
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintQingNianPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintQingNianPage);
                                    ...
                                    if (!response.IsError)
                                    {
                                        if (response.result != null)
                                        {
                                           ...
                                           // new CustomerPrint().PrintYunHaiYao(preprocessInfoList, goods, expireDay,this.dtBegin.Value);
                                            new CustomerPrint().PrintYunHaiYao(preprocessInfoList, goods, expireDay,Convert.ToDateTime(productDate),handleWay);
                                        }
                                    }
                                ...
                                else if (UserInfo.CustomerCode == "24001" || UserInfo.CustomerCode == "24002")
                                {
                                    #region 空港
                                ...
                                else if (UserInfo.CustomerCode == "20001")
                                {
                                    #region 航食
                                ...
                                else if (UserInfo.CustomerCode == "4001" || UserInfo.CustomerCode == "1001")
                                {
                                      #region 北京容大,俏凤凰
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_RongDaPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_RongDaPage);
                                ...
                                else if (UserInfo.CustomerCode == "12001")
                                {
                                    #region 异口粮食
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_YiKouLiangShiPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_YiKouLiangShiPage);
                                ...
                                else if (UserInfo.CustomerCode == "50003")
                                {
                                    #region 三全食品
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_SanQuanPrintPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_SanQuanPrintPage);
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintPangGeLiangPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintPangGeLiangPage);
                                ...
                                else if (UserInfo.CustomerCode == "50013")
                                {
                                    #region 沃弄
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintWoNongPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_PrintWoNongPage);
...
#if(!DEBUG)
                                PrintDialog dialog = new PrintDialog();
                                document.PrintPage += new PrintPageEventHandler(this.pd_YongLiDaPrintPage);
                                dialog.Document = document;
#else
                                                PrintPreviewDialog dialog = new PrintPreviewDialog();
                                                document.PrintPage += new PrintPageEventHandler(this.pd_YongLiDaPrintPage);
        ...
        private void pd_PrintPangGeLiangPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQRCode(curPreprocessInfo.preprocessCode);
            GetPrintPangGeLiangPicture(bt, e, curPreprocessInfo);
        }

        private void pd_PrintWoNongPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQRCode(curPreprocessInfo.preprocessCode);
            GetPrintWoNongPicture(bt, e, curPreprocessInfo);
        }

        private void pd_PrintNuoWaPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQRCode(curPreprocessInfo.preprocessCode);
            GetPrintNuoWaPicture(bt, e, curPreprocessInfo);
        }

        private void pd_RongDaPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQRCode(curPreprocessInfo.preprocessCode);
            GetPrintRongDaPicture(bt, e, curPreprocessInfo);
        }


        private void pd_YiKouLiangShiPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQRCode(curPreprocessInfo.preprocessCode);
            GetPrintYiKongLiangShiPicture(bt, e, curPreprocessInfo);
        }
        ...
        private void pd_PrintQingNianPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateQingQRCode(curPreprocessInfo.preprocessCode);
            GetPrintQingNianPicture(bt, e, curPreprocessInfo);
        }
        ...
        {
            Bitmap bt = CreateQingQRCode(curPreprocessInfo.preprocessCode);
            GetPrintWangYangPicture(bt, e, curPreprocessInfo);
        }
        ...
        private void pd_XiBeiPrintPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            ...
            GetXiBeiPrintPicture(bt, e, curPreprocessInfo);
              ...
              private void pd_YongLiDaPrintPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateXiBeiQRCode(curPreprocessInfo.preprocessCode);
            GetYongLiDaPrintPicture(bt, e, curPreprocessInfo);
        }


        private void pd_SanQuanPrintPage(object sender, PrintPageEventArgs e) //触发打印事件
        {
            Bitmap bt = CreateXiBeiQRCode(curPreprocessInfo.preprocessCode);
            GetSanQuanPrintPicture(bt, e, curPreprocessInfo);
        }
        ...
        public void GetPrintQingNianPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            if (goods.categoryCode == "10")
            {
                ...
                //生产日期
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
              //  g.Graphics.DrawString("生产日期:" + this.dtBegin.Value.ToShortDateString(), new Font("宋体", 10f), brush, layoutRectangleRight);
                g.Graphics.DrawString("生产日期:" + productDate, new Font("宋体", 10f), brush, layoutRectangleRight);
                //productDate
        ...
        public void GetPrintJiaHePicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            if (goods.categoryCode == "10")
            {
                ...
                {
                    baozhiqiStr = " 保质期:" + expireDay + "天";
                }

                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
             //   g.Graphics.DrawString("货主:" + UserInfo.CustomerName + " 保质期:" + expireDay + "天", new Font("宋体", 8f), brush, layoutRectangleRight);
                g.Graphics.DrawString("货主:" + UserInfo.CustomerName + baozhiqiStr, new Font("宋体", 8f), brush, layoutRectangleRight);
        ...
        public void GetPrintWangYangPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            if (goods.categoryCode == "10")
            {
                ...
                if (goods.weighed == 1)
                {
                    g.Graphics.DrawString((preprocessInfo.packWeight / 2).ToString("f2") + "KG   非即食", fontCu, brush, layoutRectangle);
                }
                else
                {
                    g.Graphics.DrawString(Decimal.ToInt32(goods.modelNum) + goods.goodsUnit + "   非即食", fontCu, brush, layoutRectangle);
        ...
        public void GetPrintPangGeLiangPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            Font fontCu = new Font("宋体", 12f, FontStyle.Bold);
            int height = 15;
            ...
            if (handleWay != null && handleWay == "毛")
            {
                height += interval;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("储存温度:0-8℃", new Font("宋体", 8f), brush, layoutRectangleRight);
            }
            else
            {
                height += interval;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("保 质 期: " + expireDay + "天  储存温度:0-8℃", new Font("宋体", 8f), brush, layoutRectangleRight);
            }
        ...
        public void GetPrintWoNongPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            Font fontCu = new Font("宋体", 12f, FontStyle.Bold);
            int height = 15;
            ...
            height += interval;
            layoutRectangle = new RectangleF(pointX, height, 300f, 30f);
            g.Graphics.DrawString("生产商电话:" + UserInfo.phone + " 经销商电话:13439033297", new Font("宋体", 6f), brush, layoutRectangle);

            height += interval;
            layoutRectangle = new RectangleF(pointX, height, 300f, 30f);
            g.Graphics.DrawString("经销商地址:北京市朝阳区小红门乡龙爪树南里68号1号楼一层122号", fontCode, brush, layoutRectangle);
        ...
        public void GetPrintNuoWaPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
        ...
        public void GetPrintRongDaPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            // if (goods.categoryCode == "10" || goods.categoryCode == "11" || goods.categoryCode == "12" || goods.categoryCode == "13" || goods.categoryCode == "17" || goods.categoryCode == "20")
            //if (goods.twoCategoryCode == "0103")
            if (goods.categoryCode == "10")
        ...
        public void GetPrintYiKongLiangShiPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            if (goods.categoryCode == "10")
            {
                ...
                //商品名称
                layoutRectangle = new RectangleF(pointX, 5, 180f, 30f);
                g.Graphics.DrawString(goods.customerGoodsName, font, brush, layoutRectangle);
         ...
         //   g.Graphics.DrawString(""+preprocessInfo.goodsName, fontCu11, brush, layoutRectangle);
          ...
          //  g.Graphics.DrawString("生产日期:" + dtBegin.Value.ToShortDateString(), new Font("宋体", 10f), brush, layoutRectangleRight);
            ...
            if (handleWay == "净")
            {
                ...
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("赏味期至:" + Convert.ToDateTime(productDate).AddDays(expireDay - 1).ToString("yyyy-MM-dd"), new Font("宋体", 10f), brush, layoutRectangleRight);
            }
            ...
            if (preprocessInfo.productWorkshopAttrDesc != null && preprocessInfo.productWorkshopAttrDesc != "" && preprocessInfo.productWorkshopAttrDesc != "净毛菜车间" && preprocessInfo.productWorkshopAttrDesc != "库房车间")
            {
                    ...
                    height += 15;
                    layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                   // g.Graphics.DrawString("赏味期:" + expireDay + "天 " + "储存方式:0-8℃", new Font("宋体", 8f), brush, layoutRectangleRight);
          ...
          public void GetYongLiDaPrintPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
         ...
         //   g.Graphics.DrawString(""+preprocessInfo.goodsName, fontCu11, brush, layoutRectangle);
            ...
            layoutRectangle = new RectangleF(pointX, height, 165f, 40f);
            g.Graphics.DrawString(preprocessInfo.goodsModel + "  非即食", font, brush, layoutRectangle);
          ...
          //  g.Graphics.DrawString("生产日期:" + dtBegin.Value.ToShortDateString(), new Font("宋体", 10f), brush, layoutRectangleRight);
            ...
            if (handleWay == "净")
            {
                ...
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("保质期至:" + Convert.ToDateTime(productDate).AddDays(expireDay - 1).ToString("yyyy-MM-dd"), new Font("宋体", 10f), brush, layoutRectangleRight);
            }
          ...
          //  g.Graphics.DrawString("食品经营许可证号：JY11117051464030", new Font("宋体", 8f), brush, layoutRectangleRight);
            ...
            if (goods.skuCode == "115064")
            {
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("生产地址:河北省廊坊市三河市李旗庄镇国家农业科技园区", new Font("宋体", 8f), brush, layoutRectangleRight);
            }

            if (goods.skuCode == "114529" || goods.skuCode == "112018")
            {
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("生产地址:北京市平谷区马坊镇英城南桥东400米", new Font("宋体", 8f), brush, layoutRectangleRight);
            }
        ...
        public void GetSanQuanPrintPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            else
            {
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("保质期:T+" + expireDay + "天", new Font("宋体", 10f), brush, layoutRectangleRight);
            }
                ...
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("储存方式:" + "1-10℃", new Font("宋体", 10f), brush, layoutRectangleRight);
                        ...
                        if (this.dataGridView1.Rows[i].Cells["isStandardProcess"].Value != null && this.dataGridView1.Rows[i].Cells["isStandardProcess"].Value.ToString() == "1")
                        {
                            ...
                            if (UserInfo.CustomerCode != "7001" && UserInfo.CustomerCode != "7002")
                            {
                                ...
                                if (UserInfo.CustomerCode == "15001" 
                                     ...
                                     || UserInfo.CustomerCode == "38001" || UserInfo.CustomerCode == "26001" || UserInfo.CustomerCode == "26002"
                                     || UserInfo.CustomerCode == "39001"
                                    )
                                {
                                    #region 青柠泰
                                ...
                                else if (UserInfo.CustomerCode == "34001")
                                {
                                    ...
                                    if (!response.IsError)
                                    {
                                        if (response.result != null)
                                        {
                                            ...
                                            new CustomerPrint().PrintYunHaiYao(preprocessInfoList,goods,expireDay,Convert.ToDateTime(this.productDate),handleWay);
                                        }
                                    }
