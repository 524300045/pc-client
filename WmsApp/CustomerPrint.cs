...
namespace WmsApp
{
    public  class CustomerPrint
    {
        ...
        public void PrintYunHaiYao(List<PreprocessInfo> preprocessInfoList, Goods _goods, double _expireDay)
        {
            goods = _goods;
        ...
        {
            Bitmap bt = CreateBigQRCode(curPreprocessInfo.preprocessCode);
        ...
        public void GetPrintYunHaiYaoPicture(Bitmap image, PrintPageEventArgs g, PreprocessInfo preprocessInfo)
        {
            ...
            if (goods.categoryCode == "10")
            {
                ...
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("保质期至:" + DateTime.Now.AddDays(expireDay).ToShortDateString(), new Font("宋体", 8f), brush, layoutRectangleRight);
                ...
                height += 15;
                layoutRectangleRight = new RectangleF(pointX, height, 300f, 85f);
                g.Graphics.DrawString("电话:010-89958567  地址:北京平谷区马坊镇英城南桥东400米", new Font("宋体", 8f), brush, layoutRectangleRight);
