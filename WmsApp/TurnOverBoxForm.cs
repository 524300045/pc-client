...
namespace WmsApp
{
    public partial class TurnOverBoxForm : TabWindow
    {

        private PaginatorDTO paginator;

        private SortableBindingList<TurnOverBox> sortList = null;

        private IWMSClient client = null;
        public TurnOverBoxForm()
        {
            InitializeComponent();
        ...
        {
            TurnOverBoxRequest request = new TurnOverBoxRequest();
            ...
            TurnOverBoxResponse response = client.Execute(request);
           if (!response.IsError)
           {
               if (response.result==null)
               {
               ...
               IPagedList<TurnOverBox> pageList = new PagedList<TurnOverBox>(response.result, recordCount, totalPage);
               sortList = new SortableBindingList<TurnOverBox>(pageList.ContentList);
        ...
        private void btnBox_Click(object sender, EventArgs e)
        {
            ...
            PrintTurnBoxStoreForm form = new PrintTurnBoxStoreForm();
            form.ShowDialog();
